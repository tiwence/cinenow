package com.tiwence.instacine.utils;
...
import com.tiwence.instacine.listener.OnRetrieveTheaterShowTimeInfoCompleted;
                ...
                while (it.hasNext()) {
                    ...
                    if (movie.id == 0) {
                        ...
                        String searchMoVieUrl = MOVIE_DB_SEARCH_MOVIE_ROOT_URL + query + "&api_key=" + MOVIE_DB_API_KEY
                                + "&language=fr&year=" + ApplicationUtils.getYear();
