...
public class MoviesFeedFragment extends android.support.v4.app.Fragment implements SwipeFlingAdapterView.onFlingListener {
    ...
    public class MoviesAdapter extends ArrayAdapter<Movie> implements View.OnClickListener {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (bst != null) {
                vh.mTimeRemaining.setText("" + ApplicationUtils.getTimeString(getActivity(), bst.mTimeRemaining));
                ...
                vh.mMovieOverView.setText(movie.overview);
                ...
                for (int i = 0; i < sts.size(); i++) {
                    ...
                    if (!s.mId.equals(bst.mId)) {
                        ...
                        tv.setText(ApplicationUtils.getTimeString(getActivity(), s.mTimeRemaining)
                                + " " + getResults().mTheaters.get(s.mTheaterId).mName);
                        tv.setTag(s);
